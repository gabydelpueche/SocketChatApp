...
export default function Login() {
  const { loginUser, loginInfo, updateLogInfo, loginError, loginLoading } = useContext(AuthContext);

  const detectChange = (e) => {
    updateLogInfo({...loginInfo, [e.target.name]: e.target.value})
  }
  return (
    <>
